...
# Github Profile Repo
Git_Profile="https://raw.githubusercontent.com/vinstechmy/VinstechmyAutoscriptPrivate/main"
...
serverV=$( curl -sS https://raw.githubusercontent.com/vinstechmy/VinstechmyAutoscriptPrivate/main/UPDATE/version)
